export const demoQrs = [
  ...
  { id: "qr_3", name: "WiFi front desk", type: "static", folder: "Operations", scans: 219, unique: 174, destination: "WIFI:S:QRForge Guest;T:WPA;P:welcome2026;;", status: "active", created_at: "2026-05-24", conversionRate: 0 },

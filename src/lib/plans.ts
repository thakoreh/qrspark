...
export const plans = [
  ...
  { id: "starter", name: "Starter", price: 9, stripePriceId: process.env.STRIPE_STARTER_PRICE_ID, headline: "Checkout-ready starter tier", limits: { dynamic: 3, static: -1, aiCredits: 25, members: 1 }, features: ["Stripe checkout route", "SVG and PDF export", "Logo upload placeholder", "Supabase schema included"] },

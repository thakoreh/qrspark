...
export function QrGenerator() {
  ...
  return <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
    <Panel className="grid gap-5">
      <div><p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500">One-click generator</p><h2 className="mt-2 text-3xl font-semibold tracking-tight">Create, save, test, download.</h2></div>
    ...
    <Panel className="grid gap-4 lg:sticky lg:top-24 lg:self-start">
      ...
      <p className="text-sm text-zinc-500">Every saved QR is tied to your account. Scan analytics appear only after your own campaign receives traffic.</p>
    </Panel>
  </div>;
}
